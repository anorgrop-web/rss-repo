...
import { TitanchefSuccessTracker } from "./success-tracker"

interface PageProps {
  searchParams: Promise<{ [key: string]: string | string[] | undefined }>
}

export default async function TitanchefSuccessPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <TitanchefSuccessTracker value={Number.parseFloat(orderData.amount)} paymentMethod={orderData.paymentMethod} />
      {/* Header */}
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  ...
                  <a href="mailto:info@titanchef.com" className="text-green-600 font-medium hover:underline">
                    info@titanchef.com
                  </a>
                </p>
              </div>
      ...
      <footer className="bg-white border-t border-gray-100 mt-8">
        <div className="mx-auto max-w-7xl px-4 py-8">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-gray-500">info@titanchef.com</p>
          </div>

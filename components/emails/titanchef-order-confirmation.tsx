...
interface TitanchefOrderConfirmationEmailProps {
  customerName: string
  orderId: string
  amount: number
...
export function TitanchefOrderConfirmationEmail({
  customerName,
  orderId,
  amount,
  paymentMethod,
  products = [],
  address,
}: TitanchefOrderConfirmationEmailProps) {
...
export default TitanchefOrderConfirmationEmail
